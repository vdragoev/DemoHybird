...
(function() {
    var provider = app.data.testJiterz = new Everlive({
            offlineStorage: true,
            appId: '1a58lmbsa32gco9w',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'testJiterz_access_token',
...
// START_CUSTOM_CODE_testJiterz
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_testJiterz