...
(function() {
    var provider = app.data.demoHybrid = new Everlive({
            offlineStorage: true,
            appId: '6kcd6ct4mb6gp1p6',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'demoHybrid_access_token',
...
// START_CUSTOM_CODE_demoHybrid
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_demoHybrid